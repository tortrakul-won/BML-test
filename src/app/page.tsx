...
export default function Home() {
  return (
    <main className="flex flex-col align-middle items-center md:mx-[20vw] mx-[10vw]">
      <span className="text-white text-[28px] font-bold my-3 flex-1 w-full">สถิติประชากรกรุงเทพฯ พ.ศ. 2550 - 2559</span>
      <span className="text-white text-[18px] font-bold my-3 flex-1 w-full">ลักษณะพื้นที่</span>
      <span className="text-white text-[14px] my-3">
        ...
        ว่าเป็น{" "}
        {
          <Link href={"https://en.wikipedia.org/wiki/Megacity"} target="_blank" className="underline">
            “อภิมหานคร (megacity)”
          </Link>
        }{" "}
